...
function LoginPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-slate-50 px-4 py-16", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-md rounded-[2rem] border border-slate-200 bg-white p-8 shadow-soft", children: [
    ...
    /* @__PURE__ */ jsx("h1", { className: "mt-3 text-center text-4xl font-black", children: "Iniciar sesión" }),
    ...
    /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "mt-8 space-y-4", children: [
      ...
      /* @__PURE__ */ jsx("button", { disabled: loading, className: "w-full rounded-2xl bg-gradient-to-r from-violet-600 to-indigo-600 px-4 py-3 font-bold text-white disabled:opacity-50", children: loading ? "Iniciando sesión..." : "Iniciar sesión" })
    ] }),
