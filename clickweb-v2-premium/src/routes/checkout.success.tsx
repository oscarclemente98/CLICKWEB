      ...
      <div className="w-full max-w-xl rounded-[2rem] border border-slate-200 bg-white p-10 shadow-soft text-center">
        {status === 'loading' ? (
          ...
          <>
            ...
            <h1 className="text-3xl font-black">{isSolo ? '¡Compra completada!' : '¡Plan activado!'}</h1>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link to="/dashboard" className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-violet-600 to-indigo-600 px-6 py-4 font-bold text-white">Ir a mi panel <ArrowRight size={18} /></Link>
