...
var templates = [
	{
		key: "ecommerce-fashion",
		name: "Tienda de moda",
		category: "Ecommerce",
		tagline: "Colecciones, banners y fichas de producto con look premium",
		emoji: "🛍️",
		accent: "#7c3aed",
		tone: "editorial",
		commerce: true
	...
	{
		key: "ecommerce-socks",
		name: "Tienda de calcetines",
		category: "Ecommerce",
		tagline: "Perfecta para marcas nicho con catálogo visual y estilo Shopify-ready",
		emoji: "🧦",
		accent: "#6d28d9",
		tone: "playful",
		commerce: true
	...
	{
		key: "ecommerce-jewelry",
		name: "Joyería",
		category: "Ecommerce",
		tagline: "Minimal, elegante y centrada en producto y confianza",
		emoji: "💍",
		accent: "#b45309",
		tone: "luxury",
		commerce: true
	...
	{
		key: "ecommerce-cosmetics",
		name: "Cosmética",
		category: "Ecommerce",
		tagline: "Texturas suaves, beneficios claros y conversión beauty",
		emoji: "💄",
		accent: "#db2777",
		tone: "soft",
		commerce: true
	...
	{
		key: "ecommerce-fitness",
		name: "Suplementos fitness",
		category: "Ecommerce",
		tagline: "Catálogo potente, beneficios directos y visual muy enérgico",
		emoji: "🏋️",
		accent: "#16a34a",
		tone: "bold",
		commerce: true
	},
	{
		...
		tagline: "Carta, reservas, testimonios y presencia local",
		emoji: "🍽️",
		accent: "#ea580c",
		tone: "warm"
	},
	{
		...
		name: "Cafetería",
		category: "Negocio local",
		tagline: "Ambiente acogedor, menú y captación por WhatsApp",
		emoji: "☕",
		accent: "#92400e",
		tone: "cozy"
	},
	{
		...
		name: "Barbería",
		category: "Negocio local",
		tagline: "Visual potente, reservas y autoridad de marca",
		emoji: "💈",
		accent: "#0f172a",
		tone: "masculine"
	},
	{
		...
		category: "Negocio local",
		tagline: "Look aspiracional, servicios y llamadas a reservar",
		emoji: "✨",
		accent: "#ec4899",
		tone: "beauty"
	},
	{
		...
		name: "Clínica",
		category: "Salud",
		tagline: "Confianza, equipo, tratamientos y captación cuidada",
		emoji: "🩺",
		accent: "#0891b2",
		tone: "trust"
	},
	{
		...
		name: "Clínica dental",
		category: "Salud",
		tagline: "Diseño limpio, autoridad y formularios listos para captar",
		emoji: "🦷",
		accent: "#0ea5e9",
		tone: "clinical"
	},
	{
		...
		name: "Fisioterapia",
		category: "Salud",
		tagline: "Servicios, enfoque humano y mensajes de confianza",
		emoji: "🧘",
		accent: "#0f766e",
		tone: "calm"
	},
	{
		...
		name: "Gimnasio",
		category: "Wellness",
		tagline: "Planes, transformación, energía y pruebas sociales",
		emoji: "🔥",
		accent: "#16a34a",
		tone: "sport"
	},
	{
		...
		tagline: "Autoridad, seriedad y captación de consultas",
		emoji: "⚖️",
		accent: "#1d4ed8",
		tone: "formal"
	},
	{
		...
		name: "Asesoría",
		category: "Profesional",
		tagline: "Servicios claros, confianza y orientación a leads",
		emoji: "📊",
		accent: "#2563eb",
		tone: "formal"
	},
	{
		...
		name: "Agencia",
		category: "Empresa",
		tagline: "Servicios premium, casos y posicionamiento fuerte",
		emoji: "🚀",
		accent: "#4f46e5",
		tone: "premium"
	},
	{
		...
		name: "Consultoría",
		category: "Empresa",
		tagline: "Propuesta sólida, credibilidad y funnel B2B",
		emoji: "🧠",
		accent: "#4338ca",
		tone: "strategic"
	},
	{
		...
		tagline: "Servicios, portfolio y contacto directo",
		emoji: "🧑‍💻",
		accent: "#7c3aed",
		tone: "clean"
	},
	{
		...
		category: "Marca personal",
		tagline: "Visual, elegante y perfecto para mostrar trabajos",
		emoji: "🎨",
		accent: "#7c2d12",
		tone: "creative"
	},
	{
		...
		name: "Coach / mentor",
		category: "Marca personal",
		tagline: "Oferta clara, autoridad y CTA de sesión",
		emoji: "🪄",
		accent: "#8b5cf6",
		tone: "inspiring"
	},
	{
		...
		tagline: "Web seria, limpia y pensada para vender",
		emoji: "🏢",
		accent: "#1e293b",
		tone: "corporate"
	},
	{
		...
		name: "Inmobiliaria",
		category: "Sectorial",
		tagline: "Propiedades, confianza y captación de contactos",
		emoji: "🏠",
		accent: "#0f766e",
		tone: "elevated"
	},
	{
		...
		category: "Sectorial",
		tagline: "Elegante, emocional y muy visual",
		emoji: "🎉",
		accent: "#be185d",
		tone: "romantic"
	},
	{
		key: "educacion",
		name: "Academia / formación",
		category: "Sectorial",
		tagline: "Cursos, metodología y captación de alumnos",
		emoji: "📚",
		accent: "#2563eb",
		tone: "academic"
	}
...
function generateDemoHtml({ description, templateName, accent, isEcommerce }) {
...
function shadeColor(color, percent) {
	...
	const g = (num >> 8 & 255) + percent;
	const b = (num & 255) + percent;
	return `#${(16777216 + (Math.max(0, Math.min(255, r)) << 16) + (Math.max(0, Math.min(255, g)) << 8) + Math.max(0, Math.min(255, b))).toString(16).slice(1)}`;
}
//#endregion
export { generateDemoHtml as n, templates as r, buildSeo as t };
