import { t as Route } from "./preview._id-Byodhwqj.js";
import { t as api } from "./lib-auth-BKomnPik.js";
import { useCallback, useEffect, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, Check, Download, ExternalLink, Loader2, Lock, RefreshCw, Star, X } from "lucide-react";
...
function PreviewPage() {
	...
	if (error) return /* @__PURE__ */ jsx("div", {
		className: "min-h-screen flex items-center justify-center bg-gray-50",
		children: /* @__PURE__ */ jsxs("div", {
			className: "text-center bg-white p-10 rounded-2xl shadow-lg max-w-md",
			children: [/* @__PURE__ */ jsx("p", {
				...
				children: [/* @__PURE__ */ jsx(ArrowLeft, { size: 18 }), "Volver al panel"]
			})]
		})
	});
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			showToolbar && /* @__PURE__ */ jsxs("div", {
				className: "fixed top-4 left-1/2 -translate-x-1/2 z-50 bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-200 px-5 py-3 flex items-center gap-4",
				children: [
					/* @__PURE__ */ jsxs(Link, {
						to: "/dashboard",
						className: "flex items-center gap-2 text-gray-600 hover:text-gray-900 text-sm transition-colors",
						children: [/* @__PURE__ */ jsx(ArrowLeft, { size: 16 }), "Mis webs"]
					}),
					...
					/* @__PURE__ */ jsxs(Link, {
						...
						children: [/* @__PURE__ */ jsx(RefreshCw, { size: 14 }), "Editar"]
					}),
					/* @__PURE__ */ jsxs("button", {
						onClick: downloadHtml,
						className: "flex items-center gap-1.5 text-gray-600 hover:text-gray-900 text-sm transition-colors",
						children: [plan === "free" ? /* @__PURE__ */ jsx(Lock, { size: 14 }) : /* @__PURE__ */ jsx(Download, { size: 14 }), plan === "free" ? "Descargar (PRO)" : "Descargar"]
					}),
					/* @__PURE__ */ jsx("button", {
			...
			!showToolbar && /* @__PURE__ */ jsx("button", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("div", {
									className: "w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-violet-100 to-indigo-100 rounded-2xl flex items-center justify-center",
								...
								/* @__PURE__ */ jsx("h3", {
									...
									children: "Descarga tu web profesional"
								}),
								/* @__PURE__ */ jsx("p", {
									className: "text-gray-500",
									children: "Tu web está lista. Elige cómo quieres obtenerla."
								})
							]
						}),
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("p", {
										...
										children: ["Solo la Web", /* @__PURE__ */ jsx("span", {
											className: "text-xs bg-emerald-600 text-white px-2.5 py-0.5 rounded-full",
											children: "Pago único"
										})]
									}) }), /* @__PURE__ */ jsxs("p", {
										className: "font-black text-xl text-emerald-600",
										children: ["49,99€", /* @__PURE__ */ jsx("span", {
									...
									children: [
										...
										"Código HTML descargable",
										"Sin suscripción"
									].map((f) => /* @__PURE__ */ jsxs("span", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("span", {
									...
									children: "O elige un plan con seguimiento"
								}),
								/* @__PURE__ */ jsx("div", { className: "flex-1 h-px bg-gray-200" })
							]
						}),
						/* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								className: `w-full text-left p-4 rounded-2xl border-2 transition-all hover:scale-[1.01] ${p.popular ? "border-violet-400 bg-gradient-to-r from-violet-50 to-indigo-50 shadow-lg shadow-violet-100" : "border-gray-200 hover:border-violet-200 hover:shadow-md"}`,
								children: [
									/* @__PURE__ */ jsxs("div", {
										className: "flex items-start justify-between mb-1",
										children: [/* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("p", {
											className: "font-bold text-gray-900 flex items-center gap-2",
											children: [p.name, p.popular && /* @__PURE__ */ jsxs("span", {
												className: "text-xs bg-gradient-to-r from-violet-600 to-indigo-600 text-white px-2.5 py-0.5 rounded-full flex items-center gap-1",
											...
											className: "font-black text-xl text-violet-600",
									...
									/* @__PURE__ */ jsxs("p", {
										className: "text-xs text-violet-500 mb-2",
										children: [
											"1er mes: ",
											p.firstMonth,
											" (30€ web + ",
									...
									/* @__PURE__ */ jsx("div", {
										className: "flex flex-wrap gap-x-4 gap-y-1",
										children: p.features.map((f) => /* @__PURE__ */ jsxs("span", {
											className: "text-xs text-gray-500 flex items-center gap-1",
											children: [/* @__PURE__ */ jsx(Check, {
												size: 12,
						...
						/* @__PURE__ */ jsx("p", {
							...
							children: "Puedes ver y editar tu web gratis. El pago es solo para descargar el código."
						})
					]
				})]
			})
