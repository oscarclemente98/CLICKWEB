...
import { rootRouteId, defaultSerovalPlugins, makeSerovalPlugin, createRawStreamRPCPlugin, isNotFound, isRedirect, createSerializationAdapter, isResolvedRedirect, executeRewriteInput } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Bgmt_qeW.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-B5faU98g.js").then((n) => n.r);
  return {
