...
import { createRawStreamRPCPlugin, createSerializationAdapter, defaultSerovalPlugins, executeRewriteInput, invariant, isNotFound, isRedirect, isResolvedRedirect, makeSerovalPlugin, rootRouteId } from "@tanstack/router-core";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-uf0AyJtU.js");
...
async function loadEntries() {
	const routerEntry = await import("./assets/router-BUIT440N.js");
	return {
